      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">
                {{ $t('student.box.personal information') }}
              </h3>
            </div>
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <el-form-item
                    :label="$t('student.label.last_name')"
                  ...
                  <div class="col-md-6">
                      <el-form-item
                          :label="$t('student.label.first_name')"
                ...
                <div class="col-md-6">
                  ...
                  >
                    <el-date-picker
                      ...
                      :placeholder="$t('student.label.birth_date')"
                    />
                    <div
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">
                {{ $t('student.box.work information') }}
              </h3>
            </div>
            <div class="box-body">
              <el-form-item
                :label="$t('student.label.company')"
                :class="{'el-form-item is-error': form.errors.has('company') }"
              >
                <el-input
                ...
                <div
                  ...
                  class="el-form-item__error"
                  v-text="form.errors.first('company')"
                />
              </el-form-item>

              <el-form-item
                :label="$t('student.label.position')"
              ...
              <el-form-item
                :label="$t('student.label.company_address')"
                :class="{'el-form-item is-error': form.errors.has('company_address') }"
              >
                <el-input
                  v-model="modelForm.company_address"
                  autocomplete="off"
                />
                <div
                  v-if="form.errors.has('company_address')"
                  class="el-form-item__error"
                  v-text="form.errors.first('company_address')"
                />
              </el-form-item>
        ...
        <div class="col-md-12">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">
                {{ $t('student.box.categories') }}
              </h3>
            </div>
            <div class="box-body">
              <el-form-item
                :label="$t('student.label.categories')"
                :class="{'el-form-item is-error': form.errors.has('categories') }"
              >
                <el-select
                  v-model="modelForm.categories"
                  style="width: 100% !important"
                  multiple
                  filterable
                ...
                <div
                  ...
                  class="el-form-item__error"
                  v-text="form.errors.first('categories')"
                />
              </el-form-item>
              <el-form-item
                :label="$t('student.label.personal_categories')"
                :class="{'el-form-item is-error': form.errors.has('personal_categories') }"
              >
                <el-select
                  v-model="modelForm.personal_categories"
                  multiple
                  filterable
                ...
                <div
                  v-if="form.errors.has('personal_categories')"
                  class="el-form-item__error"
                  v-text="form.errors.first('personal_categories')"
                />
              </el-form-item>
            </div>
          </div>
        ...
        <div class="col-md-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">
                {{ $t('student.box.grades') }}
              </h3>
            </div>
            <div class="box-body">
              <el-form-item
                :label="$t('student.label.grade joined')"
              ...
              >
                <el-select
                  ...
                  multiple
                  filterable
                  :placeholder="$t('student.label.grade joined')"
                >
                  <el-option
...
export default {
  ...
  data () {
    return {
      ...
      listGender: [
        {
          value: this.$t('student.label.male'),
          label: this.$t('student.label.male')
        },
        {
          value: this.$t('student.label.female'),
          label: this.$t('student.label.female')
        },
        {
          value: this.$t('student.label.other'),
  ...
  methods: {
    onSubmit () {
      ...
      this.form.post(this.getRoute())
        .then((response) => {
          ...
          this.$router.push({ name: 'admin.student.index' })
        })
        .catch((error) => {
          this.loading = false
          this.$notify.error({
    ...
    fetchData () {
      ...
      if (this.$route.params.userId !== undefined) {
        this.loading = true
        routeUri = route('api.student.find', { user: this.$route.params.userId })
        axios.get(routeUri)
          .then((response) => {
            this.loading = false
    ...
    getRoute () {
      if (this.$route.params.userId !== undefined) {
        return route('api.student.update', { user: this.$route.params.userId })
      }
      return route('api.student.store')
    },
