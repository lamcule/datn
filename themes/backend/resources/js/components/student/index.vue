                ...
                >
                    ...
                    >
                        <el-select
                            ...
                            :placeholder="$t('student.label.status')"
            ...
            <div class="box-body">
                <div class="sc-table">
                    ...
                    >
                            ...
                            <template slot-scope="props">
                                ...
                                >
                                    <div class="col-md-3">
                                        ...
                                        <p>{{ $t('student.label.gender') }}: {{ props.row.profile.gender }}</p>
                                        <p>{{ $t('student.label.email') }}: {{ props.row.email }}</p>
                                        <p>{{ $t('student.label.created_at') }}: {{ props.row.created_at }}</p>
                                        <p>
                                            {{ $t('student.label.grade') }}: <span class="badge bg-danger"
                          ...
                          >{{ grade.name }}</li>
                                    ...
                                    <div class="col-md-9">
                                        <p v-if="props.row.profile">{{ $t('student.label.province_id') }}: {{
                                                props.row.profile.province ?
                                                    props.row.profile.province.name : ''
                                            }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.district_id') }}: {{
                                                props.row.profile.district ?
                                                    props.row.profile.district.name : ''
                                            }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.phoenix_id') }}: {{
                                                props.row.profile.phoenix ?
                                                    props.row.profile.phoenix.name : ''
                                            }}</p>
                        ...
                        >
                            <template slot-scope="props">
                                <span>{{ props.row.profile.birth_date }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column
                            prop="email"
                        ...
                        >
                            <template slot-scope="props">
                                <span v-if="props.row.profile.gender == 'male'"> {{ $t('student.label.male') }}</span>
                                <span v-else-if="props.row.profile.gender == 'female'"> {{ $t('student.label.female') }}</span>
                                <span v-else> {{ $t('student.label.other') }}</span>
                            </template>
                        </el-table-column>
