    ...
    <div>
        ...
        <div class="row">
            <div class="col-md-12 row-action">
                <router-link :to="{name: 'admin.teacher.create'}">
                    <el-button
                        type="primary"
                        size="small"
                        class="btn btn-flat"
                    ...
                    >
                        <el-table-column type="expand">
                            <template slot-scope="props">
                                ...
                                >
                                    ...
                                    <div class="col-md-9">
                                        <p v-if="props.row.profile">{{ $t('teacher.label.province_id') }}: {{
                                            props.row.profile.province?
                                            props.row.profile.province.name : '' }}</p>
                                        <p v-if="props.row.profile">{{ $t('teacher.label.district_id') }}: {{
                                            props.row.profile.district?
                                            props.row.profile.district.name : '' }}</p>
                                        <p v-if="props.row.profile">{{ $t('teacher.label.phoenix_id') }}: {{
                        ...
                        <el-table-column prop="actions">
                            <template slot-scope="scope">
                                <edit-button
                                    :to="{name: 'admin.teacher.edit', params: {userId: scope.row.id}}"
                                />
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //   this.$message({
            //     type: 'success',
            //     message: this.$t('teacher.messages.import success'),
            //   });
