    ...
    <div class="col-xs-12">
      <div class="sc-table">
          ...
          <div class="title">
            ...
            <div class="media-breadcrumb">
              ...
              >
                ...
                <el-breadcrumb-item :to="{name: 'admin.media.index'}">
                  {{ $t('media.label.media') }}
                </el-breadcrumb-item>
              </el-breadcrumb>
            </div>
        ...
        <div class="box box-primary">
          <div class="box-body">
            <div
              class="tool-bar el-row"
              style="padding-bottom: 20px;"
            >
              <div class="actions el-col el-col-14">
                <new-folder :parent-id="folderId" />
            ...
            <el-row>
              <el-col :span="24">
                ...
                >
                  <el-breadcrumb-item
                    v-for="(folder, index) in folderBreadcrumb"
                    :key="folder.id"
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  ...
                  >
                  <i
                    v-if="! scope.row.is_image && ! scope.row.is_folder"
              ...
              <el-table-column
                prop="created_at"
                :label="$t('media.label.created_at')"
                sortable="custom"
                width="150"
              />
              <el-table-column
              ...
              >
                <template slot-scope="scope">
                  <div class="pull-right">
                    ...
                    <i
                      v-if="scope.row.hideAfterInsert"
                      class="el-icon-success"
                      style="color: green;font-size: 24px;"
                    />
                    <div v-if="! singleModal">
                      <el-button size="mini"  icon="el-icon-download" v-if="! scope.row.is_folder"  @click.prevent="downloadFile(scope.row)"></el-button>


                      <el-button-group>
                        <edit-button
                          v-if="! scope.row.is_folder"
                          :to="{name: 'admin.media.edit', params: {mediaId: scope.row.id}}"
                        />
                        <el-button
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      this.$confirm(this.$t('core.modal.confirmation-message'), this.$t('core.modal.title'), {
