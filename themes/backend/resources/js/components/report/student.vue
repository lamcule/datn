                    ...
                    >
                            ...
                            <template slot-scope="props">
                                ...
                                >
                                    <div class="col-md-3">
                                        ...
                                        <p>
                                            Lớp học đã đăng ký: <span class="badge bg-danger"
                        ...
                        <ul>
                          ...
                          >{{ grade.name }}</li>
                                    ...
                                    <div class="col-md-9">
                                        <p v-if="props.row.profile">{{ $t('student.label.province_id') }}:
                                            {{ props.row.profile.province ? props.row.profile.province.name : '' }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.district_id') }}:
                                            {{ props.row.profile.district ? props.row.profile.district.name : '' }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.phoenix_id') }}:
                                            {{ props.row.profile.phoenix ? props.row.profile.phoenix.name : '' }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.address') }}:
                                            {{ props.row.profile.address }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.company') }}: <span
                                            class="badge bg-aqua">{{ props.row.profile.company }}</span></p>
                                        <p v-if="props.row.profile">{{ $t('student.label.position') }}:
                                            {{ props.row.profile.position }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.company_address') }}:
                                            {{ props.row.profile.company_address }}</p>
                                        <p v-if="props.row.profile">{{ $t('student.label.categories') }}: <span
                                            class="badge bg-warning">{{
                                                props.row.profile.categories.join(', ')
                                            }}</span></p>
                                        <p v-if="props.row.profile">{{ $t('student.label.personal_categories') }}: <span
                                            class="badge bg-danger">{{
                                                props.row.profile.personal_categories.join(', ')
                                            }}</span></p>
                                    </div>
                                </div>
                            </template>
                        ...
                        <el-table-column
                            prop="deleted_at"
                            :label="$t('student.label.deleted_at')"
                            sortable="custom"
                        />
