...
class ImageServiceProvider extends ServiceProvider
{
    ...
    private function registerThumbnails()
    {
        ...
        $this->app[ThumbnailManager::class]->registerThumbnail('l', [
            'resize' => [
                'width' => 500,
                'height' => null,
                'callback' => function ($constraint) {
        ...
        // Ảnh thumb cho news collection ở trang news feed
        $this->app[ThumbnailManager::class]->registerThumbnail('news_collection_thumb', [
            'resize' => [
                'width' => 200,
                'height' => null,
                'callback' => function ($constraint) {
        ...
        $this->app[ThumbnailManager::class]->registerThumbnail('news_normal_thumb', [
            'resize' => [
                'width' => 608,
                'height' => null,
                'callback' => function ($constraint) {
        ...
        $this->app[ThumbnailManager::class]->registerThumbnail('news_featured_thumb', [
            'fit' => [
                'width' => 100,
                'height' => null,
                'callback' => function ($constraint) {
