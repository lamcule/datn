...
class PermissionController extends ApiController
{
    ...
    {
        $this->permissionRepository->create($request->only('name', 'guard_name', 'description'));
    ...
    {
        $this->permissionRepository->update($permission, $request->only('name', 'guard_name', 'description'));
